...
import 'package:car_pool/view/navbar_pages/driverOrdersReceived/components/receivedOrder_container.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:provider/provider.dart';

class ReceivedOrderList extends StatefulWidget {
  const ReceivedOrderList({super.key});

  @override
  State<ReceivedOrderList> createState() => _ReceivedOrderListState();
}

class _ReceivedOrderListState extends State<ReceivedOrderList> {
  @override
                  ...
                  child: Column(
                    children: [
                      ...getFilteredList(ordersFetched, ctrl.buttonPressed)
                          .map((order) => ReceivedOrderContainer(order: order)),
                    ],
                  ),
                ),
              );
